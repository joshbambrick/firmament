...
#ifndef FIRMAMENT_SCHEDULING_COCO_RESERVATIONS_COST_MODEL_H
#define FIRMAMENT_SCHEDULING_COCO_RESERVATIONS_COST_MODEL_H
...
class CocoReservationsCostModel : public CostModelInterface {
 public:
  CocoReservationsCostModel(shared_ptr<ResourceMap_t> resource_map,
...
#endif  // FIRMAMENT_SCHEDULING_COCO_RESERVATIONS_COST_MODEL_H
